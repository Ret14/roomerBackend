...
| 2.3    	 | 15.05.2023 	 |                                                                      Добавил запросы проверки подписки и выхода из учетной записи                                                                      |                                                            
...
### Проверка наличия объявления в избранном
#### Пояснения:
user_id - id пользователя, для которого делаем проверку, housing_id - id комнаты
#### Примеры запросов
#### Запрос:
    curl -X GET \
        http://176.113.83.93:8000/favourites/check_favourite/?user_id=1&housing_id=1 \
        -H 'Authorization: Token b704c9fc3655635646356ac2950269f352ea1139'
#### Ответ:
    Response code: 200
